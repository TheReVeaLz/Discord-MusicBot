...
module.exports = {
	...
	spotifyId: process.env.spotifyId || "", //- Spotify token ID
	spotifySecret: process.env.spotifySecret || "", //- Spotify token secret
	...
	iconURL: "https://cdn-icons-png.flaticon.com/512/18/18471.png", //- This icon will be in every embed's author field
};