...
class DiscordMusicBot extends Client {
  ...
  build() {
    ...
    this.manager = new Manager({
      ...
      //   new deezer(),
      //   new AppleMusic(),
      //   new spotify({ strategy: "API", clientId: this.config.spotifyId, clientSecret: this.config.spotifySecret }),
      //   new facebook(),
      //   new filters(),
      // ],
      autoPlay: true,
          ...
          try {
            ...
            let trackStartedEmbed = this.Embed()
              ...
              .addFields(
                {
                  name: "Requested by",
                  value: `${track.info.requester || `<@${client.user.id}>`}`,
                  inline: true,
                },
                {
                  name: "Duration",
        ...
        /** @param {EpicPlayer} */ async (player, track) => {
          ...
          if (autoQueue) {
            ...
            res.tracks.some((track, index) => {
              ...
              return !playedTracks.includes(track.info.identifier);
            });
